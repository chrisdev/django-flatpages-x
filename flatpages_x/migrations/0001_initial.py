...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FlatPageAttachment'
        db.create_table('flatpages_x_flatpageattachment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('flatpage', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='attachments', null=True, to=orm['flatpages.FlatPage'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('attachment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File'], null=True, blank=True)),
        ))
        db.send_create_signal('flatpages_x', ['FlatPageAttachment'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'FlatPageAttachment'
        db.delete_table('flatpages_x_flatpageattachment')
    ...
    models = {
        ...
        'flatpages_x.flatpageattachment': {
            'Meta': {'object_name': 'FlatPageAttachment'},
            'attachment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filer.File']", 'null': 'True', 'blank': 'True'}),
            'flatpage': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'attachments'", 'null': 'True', 'to': "orm['flatpages.FlatPage']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
